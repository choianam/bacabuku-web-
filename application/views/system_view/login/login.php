...
<head>
  ...
  <link href="<?php echo base_url('assets/sb/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i')?>" rel="stylesheet">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="p-5">
                ...
                <form class="user" action="<?php echo base_url('user');?>" method="POST">
